...
import codepen from "../assets/instagram.svg";
      ...
      <Wrapper>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-5 2xl:mt-[63px] relative text-[#111111] border-t border-[#CCCCCC] py-10">
          <div className="flex items-center gap-[6px]">
            ...
            <div>chandru007raju@gmail.com</div>
          </div>
          <div></div>
          ...
          <div className="flex items-center gap-3">
            <a
              href="https://www.linkedin.com/in/sr-chandra-shekar007/"
              target="_blank"
            >
              <img src={linkedin} alt="LinkedIn" className="w-[25px]" />
            </a>
            <a href="https://github.com/chandru007raju" target="_blank">
