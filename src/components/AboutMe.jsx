  ...
  return (
    ...
    >
      ...
      <Wrapper>
        ...
        <Div className="text-[34px] md:text-[70px] 2xl:text-[185px] leading-[36px] md:leading-[70px] 2xl:leading-[100px] font-oswald uppercase mb-[22px] md:mb-[34px] 2xl:mb-[48px] flex flex-col relative">
          ...
          <span className="flex items-center gap-2">
            ...
            <img
              src={flag}
              alt=""
              className="w-[62px] md:w-[150px] 2xl:w-[190px] block mt-1 md:mt-2"
            />
            <span>India</span>
          </span>
        </Div>
        ...
        >
          ...
          Welcome to my portfolio! My name is S R Chandrashekar, and
          I am a Software Engineer and a skilled Frontend Web Developer with a passion for creating
          ...
          free time, I enjoy making new projects and experimenting with new technologies.
          <h2 style={{ fontFamily: "'Cedarville Cursive',cursive" }}>
            &lt;br/&gt;
          </h2>{" "}
          <br />
