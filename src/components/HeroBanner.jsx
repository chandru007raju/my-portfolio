    ...
    >
      ...
      <Wrapper>
        ...
        &lt;h1&gt;
          ...
          <h1 className="text-[25px] md:text-[60px] 2xl:text-[94px] leading-[25px] md:leading-[63px]  2xl:leading-[95px] font-oswald uppercase">
            I'm sr.chandra shekar !!
            <br className="invisible md:visible" />
            Computer Science Engg graduate
            {/* S/w engg & Web-Developer */}
          </h1>
       ...
       <h2 style= {{fontFamily: "'Cedarville Cursive',cursive"}} >&lt;p&gt;</h2>   I'm a Programmer and front-end developer. Passionate about building
            user-loving accessible web apps and coding. My job is to build your website
